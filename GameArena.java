...
public class GameArena extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener {
		...
		synchronized (this) {
			if (!this.exiting) {
				...
				if (backgroundImage != null)
					graphics.drawImage(backgroundImage, 0, 0, arenaWidth, arenaHeight, 0, 0, backgroundImage.getWidth(null),
				...
				for (Object o : things) {
					if (o instanceof Ball) {
						...
						graphics.fillOval((int) (b.getXPosition() - b.getSize() / 2), (int) (b.getYPosition() - b.getSize() / 2),
	 ...
	 * This method causes your program to delay for 1/50th of a second. You'll find
